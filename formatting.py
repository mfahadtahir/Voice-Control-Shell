...
def show_list():
    ...
    table_content('8', 'File type', 'The file information will be displayed')
    table_content('9', 'Create User', 'The new user will be created.')
    table_content('10', 'Delete User', 'Deletes the user.')
    table_content('11', 'Current Directory', 'Current working Directory will be displayed')
    table_content('12', 'Create Directory', 'New Directory will be created')
    table_content('13', 'Go Back', 'Move to the previous directory')
